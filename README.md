...
bitcore-message-privy adds support for verifying and signing privy messages in [Node.js](http://nodejs.org/) and web browsers.
...
```sh
npm install bitcore-message-privy
```

```sh
bower install bitcore-message-privy
```
